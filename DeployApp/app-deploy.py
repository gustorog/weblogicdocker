...
domainname = os.environ.get('DOMAIN', 'DOMAIN_APP')
domainhome = os.environ.get('ASERVER', '/u01/oracle/Domains/aserver/' + domainname)
admin_name = os.environ.get('ADMIN_NAME', 'AdminServer')
appname    = os.environ.get('APP_NAME', 'SampleWebApp')
appfile    = os.environ.get('APP_FILE', 'SampleWebApp.war')
...
app.setSourcePath('/u01/oracle/DeployApp/'+appfile)
